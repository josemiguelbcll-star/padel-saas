-- ============================================================================
-- 0109_fix_midnight_tsrange_booking.sql
-- Corrige fn_reservar_desde_app, fn_crear_reserva, y fn_aceptar_desafio
-- para que los tsrange calculen el límite superior como (inicio + duracion * interval)
-- evitando el error "range lower bound must be less than or equal to range upper bound"
-- cuando un turno cruza la medianoche (ej. 23:00 a 01:00).
-- ============================================================================
...
BEGIN
  ...
  -- 1. Chequeo de clases activas con tsrange seguro
  IF EXISTS (
