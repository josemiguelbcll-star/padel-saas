...
BEGIN
  ...
  -- Resolver email desde auth.users
  ...
  -- A. Si la cancha tiene tarifa_id asignada directamente
  ...
  -- B. Si no tiene tarifa fija asignada o está inactiva, resolver por horario/días
