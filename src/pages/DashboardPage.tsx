...
// Cargar gráficos de forma perezosa (lazy) para reducir el bundle inicial
const IngresosUnidadChart = lazy(() =>
  import('@/features/dashboard/DashboardCharts').then((m) => ({
    default: m.IngresosUnidadChart,
  }))
);
const EvolucionDiariaChart = lazy(() =>
  import('@/features/dashboard/DashboardCharts').then((m) => ({
    default: m.EvolucionDiariaChart,
  }))
);
